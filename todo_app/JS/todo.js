...
function add() {
    ...
    var todos = get_todos();
    //this adds a new tast the end of the array
    todos.push(task);
...
function show() {
    //thhis set the task that was retrieved as a variable
    var todos = get_todos();
    ...
    html += '</ul>';
    //this displays teh task as a list
...
//this tells the browser how to display teh todo array after an item has been removed
