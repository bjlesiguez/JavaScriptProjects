//Creates an objecct to keep track of values.
const Calculator = {
...
function Handle_Operator(Next_Operator) {
  ...
  const kets = document.querySelector('.calculator-keys');
  kets.addEventListener('click', (event) => {
